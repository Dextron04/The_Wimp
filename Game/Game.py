...
def credits():
    print("This game is created by Tushin Kulshreshtha,")
    print("Storyline of this game is taken from another creator,")
    print("Well next time I'll try to make my own story but for now let\'s just go with the flow,")
    print("If you encounter any issues while playing, please let me know,")
def intro():
